...
public void salesTableLoad(){
       
        try {
           String getItemsBillSQL = "SELECT No,Cname,Cid,Iname,Iid,Billid,Quantity,Price,Date FROM customer_item_bills";
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("Tahoma", 1, 85)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jSeparator1, javax.swing.GroupLayout.DEFAULT_SIZE, 1923, Short.MAX_VALUE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jButton2, javax.swing.GroupLayout.PREFERRED_SIZE, 733, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(561, 561, 561))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Admin_Bills adbi = new Admin_Bills();
        adbi.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!Search.matches("^[0-9]+{2}+$")) {
            JOptionPane.showMessageDialog(null, "Please enter Bill ID only!");
            jTextField1.setText(null);
          
        } else {
                 
            String sql = "SELECT No,Cname,Cid,Iname,Iid,Billid,Quantity,Price,Date FROM customer_item_bills WHERE Billid LIKE '%" + Search + "%'";
