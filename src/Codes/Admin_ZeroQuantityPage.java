 ...
 * @author Dananjaya
 */
public class Admin_ZeroQuantityPage extends javax.swing.JFrame {
    ...
    public void itemsTableLoad(){
       ...
       try {
           String retrieveItemsSQL = "SELECT Id,Name,P_date,I_Date,Supplier,Purchase_Price,Sell_Price,Quantity,Total_price FROM admin_itemstable WHERE Quantity = '"+ 0 +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_ZeroQuantityPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_ZeroQuantityPage().setVisible(true);
            }
        });
    }
